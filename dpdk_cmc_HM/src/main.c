...
#include <health_monitor.h>  // CMC health monitor (ring + dashboard)
...
int main(int argc, char const *argv[])
{
    ...
    while (!force_quit)
    {
        ...
        // CMC Health Monitor — ring'i drain edip her item için ilgili
        // print_* fonksiyonunu çağırır. rx_worker dispatch'i TxRxManager.c
        // içinde hm_handle_packet()'e enqueue ediyor.
        hm_print_dashboard();
